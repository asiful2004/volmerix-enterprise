        ...
        <div class="container mx-auto px-4 py-3 md:py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    <a href="index.html" class="text-xl md:text-2xl font-bold text-purple-600">
                        <span class="hidden sm:inline">Volmerix Enterprise</span>
                        <span class="sm:hidden">Volmerix</span>
                    </a>
                </div>
